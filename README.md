...
אם זאת, ישנן מספר לקונות שכדאי לקחת בחשבון:
...
- המילון לא עודכן ל[כללי הכתיב המלא מ-2017](https://hebrew-academy.org.il/topic/hahlatot/missingvocalizationspelling). בפרט:
  - מילים להן התווספה ו: אונייה, חוכמה, למוחרת, צוהריים, קודקוד, הקורבן, קורבני, תוכנות, תוכניתי, האומנותי (איך אפשר לקבוע להיפגש במקום שאינו במילון??)
  - מילים להן התווספה י: אידיאל (לאידיאל!), איטי\ות, אימו\ך, איתה\ו\ך\ם, אמיתי\ת, בריכה, הינה\ו\ך\ם\ני, ליבי\ך\ם, מגינים, מייד, המיידי, מקילות, סיסמה, עימו\י\ך, עיזים, לעיתים, פירות, ריאלי, השיער, שיערות, תיאטרון
  - הבעיה כמובן היא להכליל לנטיות השונות ולתחיליות שונות
  - מאידך כן מופיעות הצורות הישנות שכיום אינן עוד תקניות 
- חסרות מילים [בבניין נתפעל](https://hebrew-academy.org.il/2018/07/24/התבקשנו-או-נתבקשנו-על-התפעל-ונתפעל) כמו: נזדקקתי, נצטוותי, נתבדתי, נתגלתי, נתמנתי, נתפוגגתי
...
<h2>Remarks</h2>
This file was written using [Markdown Editor](https://jbt.github.io/markdown-editor), the only one I found that respects html dir=rtl tags, while retaining markdown semantics inside the div. 
