	...
	foreach $W ('','ו'){
	  foreach $S ('','ה','ש'){
		...
		foreach $B ('','ב','ה','כ','ל','מ','מה'){
		  ...
		  $prefix = "$W$S$K$k$B";
          next if length($prefix)>1 && $prefix ne 'כש' && $prefix ne 'וה' && $prefix ne 'מה' && $prefix ne 'וב' && $prefix ne 'ול' && $prefix ne 'וכ' && $prefix ne 'וש' && $prefix ne 'ומ' && $prefix ne 'שה' && $prefix ne 'ומה' && $prefix ne 'ושה' && $prefix ne 'וכש' && $prefix ne 'וכשה' && $prefix ne 'כשה';
		  $mask = $PS_MISC;
